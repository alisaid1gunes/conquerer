...
export class AuthController {
  ...
  @Post('/login')
  @HttpCode(200)
  async login(@Res() response: Response, @Body() loginDto: LoginDto): Promise<ApiResponseType> {
    try {
  ...
  async logout(@Res() response: Response, @CurrentUser() user: User): Promise<ApiResponseType> {
    try {
  ...
  @HttpCode(200)
  @UseBefore(AuthMiddleware)
  async deleteAccount(@CurrentUser() user: User): Promise<ApiResponseType> {
    try {
